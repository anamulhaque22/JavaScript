...
// call and apply method is mostly semilir but the main diffenence is call method take individual value after the object and apply method cannot take indivisual value. apply method take array as an argument.
...
//ফাংশন এর সাথে bind মেথধ এ কোন অবজেক্ট দিয়ে ফাংশন কে কল করা হলে ফাংশনের বডিতে this bind এর সাথে দেওয়া অবজেক্টকে রেফার করবে কেন্তু bind সাথে সাথে ফাংশনকে কল করে না। কল করার জন্য ফাংশনকে কনো একটা variable এ রাখতে হয়।
